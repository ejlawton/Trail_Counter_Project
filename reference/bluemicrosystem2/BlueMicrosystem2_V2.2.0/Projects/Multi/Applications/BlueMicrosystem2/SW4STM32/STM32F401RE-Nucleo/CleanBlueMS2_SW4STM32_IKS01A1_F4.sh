...
echo "/******************************************/"
${OpenOCD_CMD} -c "program  ../../../../../../Utilities/BootLoader/STM32F401RE-Nucleo/BootLoaderF4.bin exit 0x08000000"
echo "/******************************************/"
echo "          Install BlueMicrosystem2"
echo "/******************************************/"
${OpenOCD_CMD} -c "program  ./STM32F4xx-Nucleo/IKS01A1/BlueMS2_IKS01A1_NucleoF4.bin exit reset 0x08004000"
echo "/******************************************/"
echo "    Dump BlueMicrosystem2 + BootLoader"
echo "/******************************************/"

SizeBinBL=`ls -l ./STM32F4xx-Nucleo/IKS01A1/BlueMS2_IKS01A1_NucleoF4.bin | awk '{print $6+0x4000};'`
${OpenOCD_CMD} -c "init" \
			   -c "reset halt" \
			   -c "sleep 100" \
			   -c "wait_halt 2" \
			   -c "dump_image ./STM32F4xx-Nucleo/IKS01A1/BlueMS2_IKS01A1_NucleoF4_BL.bin 0x08000000 ${SizeBinBL}" \
			   -c "reset halt" \
			   -c "shutdown"
